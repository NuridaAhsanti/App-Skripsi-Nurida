 ...
 * @author nury
 */
public class CariJawabanStemJar extends javax.swing.JFrame {
 ...
 public String filter(String str){
     ...
     tutorialKoneksi connection = new tutorialKoneksi();
        ...
        try {
            ...
            Logger.getLogger(CariJawabanStemJar.class.getName()).log(Level.SEVERE, null, ex);
        }
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariJawabanStemJar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CariJawabanStemJar().setVisible(true);
            }
        });
    }
